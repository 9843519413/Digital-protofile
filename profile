...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="BALAJI S" alt="your profile picture" class="profile=picture">
               <h1>Balaji</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone! This is BALAJI S and i am a computer science learner.</p>
                </div>
            </section>
